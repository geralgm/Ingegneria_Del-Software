...
from listaordini.views.VistaInserisciOrdine import VistaInserisciOrdine
...
class VistaListaOrdini(QWidget):
    def __init__(self, parent=None):
        ...
        self.ButtonNuovoOrdine.clicked.connect(self.show_inserisci_ordine)
    ...
    def show_selected_info(self):
        if(len(self.list_view.selectedIndexes()) > 0):
            ...
            self.vista_ordine = VistaOrdine(ordine_selezionato, self.controller.elimina_ordine_by_codice, self.update_ui)
            self.vista_ordine.show()

    def show_inserisci_ordine(self):
