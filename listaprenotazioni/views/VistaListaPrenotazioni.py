...
from prenotazione.view.VistaPrenotazione import VistaPrenotazione
...
class VistaListaPrenotazioni(QWidget):
    def __init__(self, parent=None):
        ...
        self.buttonNuovaprenotazione.setStyleSheet("QPushButton#buttonNuovaprenotazione{\n"
                                                    "  background-color:#293d3d;\n"
                                                    "  border-radius: 30px;\n"
                                                    "  color: white;\n"
                                                    "  padding: 16px 32px;\n"
                                                    ...
                                                    "  cursor: pointer;\n"
                                                    "}\n"
                                                    "QPushButton#buttonNuovaprenotazione:pressed{\n"
                                                    " background-color: white; \n"
                                                    "  color: black; \n"
                                                    "  border: 3px solid #4CAF50;\n"
                                                    "}\n"
                                                    "QPushButton#buttonNuovaprenotazione:hover {background-color:      #d1e0e0;}")
        self.buttonNuovaprenotazione.setObjectName("buttonNuovaprenotazione")
    ...
    def update_ui(self):
        ...
        for prenotazione in self.controller.get_lista_prenotazioni():
            ...
            item = QStandardItem()
            item.setText(prenotazione.nome_cliente + ": " + prenotazione.cognome_cliente)
